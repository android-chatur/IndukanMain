...
import com.geogreenapps.apps.indukaan.activities.MainActivity;
import com.geogreenapps.apps.indukaan.activities.MessengerActivity;
import com.geogreenapps.apps.indukaan.adapter.lists.ListUsersAdapter;
...
import com.geogreenapps.apps.indukaan.helper.AppHelper;
    ...
    public void getUsers(final int page) {
        ...
        SimpleRequest request = new SimpleRequest(Request.Method.POST,
            ...
            protected Map<String, String> getParams() {
                ...
                if (APP_DEBUG) {
                    Log.e("ListUsersFragment", "  params getProduct :" + params.toString());
                }
