 ...
 * =============================================================================
 */
package com.geogreenapps.apps.indukaan.unbescape.javascript;
...
final class JavaScriptEscapeUtil {
     ...
     */
    private static final int SEC_CHARS_LEN = '\\' + 1; // 0x5C + 1 = 0x5D
    private static final char SEC_CHARS_NO_SEC = '*';
    private static final char[] SEC_CHARS;
