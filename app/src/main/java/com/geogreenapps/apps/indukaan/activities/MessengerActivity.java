...
import com.geogreenapps.apps.indukaan.Services.Pusher;
import com.geogreenapps.apps.indukaan.adapter.messenger.ListMessageAdapter;
...
import com.geogreenapps.apps.indukaan.parser.api_parser.MessageParser;
 ...
 */
public class MessengerActivity extends GlobalActivity implements ListMessageAdapter.ClickListener,
    ...
    */
    ...
    private void displayBtnLoading() {
        ...
        adapter.setLoadEarlierMsgs((adapter.getItemCount() - 1) < COUNT);
        adapter.notifyDataSetChanged();
