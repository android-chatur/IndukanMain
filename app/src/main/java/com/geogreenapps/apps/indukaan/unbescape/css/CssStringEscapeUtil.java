 ...
 * =============================================================================
 */
package com.geogreenapps.apps.indukaan.unbescape.css;
...
final class CssStringEscapeUtil {
     ...
     */
    private static final int BACKSLASH_CHARS_LEN = '~' + 1; // 0x7E + 1 = 0x7F
    private static final char BACKSLASH_CHARS_NO_ESCAPE = 0x0;
    private static final char[] BACKSLASH_CHARS;
