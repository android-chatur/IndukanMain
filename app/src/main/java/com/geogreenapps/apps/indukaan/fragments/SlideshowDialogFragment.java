...
import com.geogreenapps.apps.indukaan.classes.SimpleImage;
import com.geogreenapps.apps.indukaan.views.BlurImageView;
import com.geogreenapps.apps.indukaan.views.HackyViewPager;
            ...
            Glide.with(getActivity())
                    ...
                    .listener(new RequestListener<Drawable>() {
                        ...
                        public boolean onLoadFailed(@Nullable GlideException e, Object model, Target<Drawable> target, boolean isFirstResource) {
                            ...
                            Toast.makeText(getContext(), "Error loading pictures", Toast.LENGTH_LONG).show();
