package com.geogreenapps.apps.indukaan.adapter.navigation;
...
public class SimpleListAdapterNavDrawer extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private final List<ItemNav> data;
    private final Context context;
    private ClickListener clickListener;

    public SimpleListAdapterNavDrawer(Context context, List<ItemNav> data) {
        this.data = data;
    ...
    public void update(int position, ItemNav item) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holderViews, int position) {
        ...
        if (holderViews instanceof mViewHolder) {
            ...
            holder.nameItemNav.setText(data.get(position).getName());
            ...
            if (data.get(position).getIconDraw() != null) {
                ...
                holder.imageItemNav.setImageDrawable(pinIcon);
                if (!data.get(position).isEnabled()) {
                ...
                holder.imageItemNav.setImageDrawable(
    ...
    public class mViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        //for item menu
        TextView nameItemNav;
        ImageView imageItemNav;
        TextView notify;
        View root;
        ...
        public mViewHolder(View itemView) {
            ...
            //for item menu
            nameItemNav = itemView.findViewById(R.id.itemtext);
            imageItemNav = itemView.findViewById(R.id.itemimage);
