...
import com.geogreenapps.apps.indukaan.helper.MyPreferenceManager;
import com.geogreenapps.apps.indukaan.network.ServiceHandler;
import com.geogreenapps.apps.indukaan.security.Security;
...
public class AppController extends MultiDexApplication {
    ...
    public static final String TAG = AppController.class
            .getSimpleName();
    private static final String fcmToken = "";
    private static HashMap<String, String> tokens = null;
    private static final ArrayList<String> listLangsIndex = null;
    ...
    private void parseAppConfig() {
        ...
        AppConfig.HOME_QUICK_ACCESS = Boolean.parseBoolean(getResources().getString(R.string.HOME_QUICK_ACCESS));
