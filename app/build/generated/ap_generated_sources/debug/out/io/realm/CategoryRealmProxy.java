...
public class CategoryRealmProxy extends com.geogreenapps.apps.indukaan.classes.Category
    ...
    private ProxyState<com.geogreenapps.apps.indukaan.classes.Category> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.geogreenapps.apps.indukaan.classes.Category>(this);
    ...
    @Override
    public com.geogreenapps.apps.indukaan.classes.Images realmGet$logo() {
        proxyState.getRealm$realm().checkIfValid();
        if (proxyState.getRow$realm().isNullLink(columnInfo.logoIndex)) {
            return null;
        }
        return proxyState.getRealm$realm().get(com.geogreenapps.apps.indukaan.classes.Images.class, proxyState.getRow$realm().getLink(columnInfo.logoIndex), false, Collections.<String>emptyList());
    }

    @Override
    public void realmSet$logo(com.geogreenapps.apps.indukaan.classes.Images value) {
        if (proxyState.isUnderConstruction()) {
            if (!proxyState.getAcceptDefaultValue$realm()) {
                return;
            }
    ...
    @SuppressWarnings("cast")
    public static com.geogreenapps.apps.indukaan.classes.Category createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(2);
        com.geogreenapps.apps.indukaan.classes.Category obj = null;
        if (update) {
            Table table = realm.getTable(com.geogreenapps.apps.indukaan.classes.Category.class);
            CategoryColumnInfo columnInfo = (CategoryColumnInfo) realm.getSchema().getColumnInfo(com.geogreenapps.apps.indukaan.classes.Category.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.geogreenapps.apps.indukaan.classes.Category.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            ...
            if (json.has("numCat")) {
                if (json.isNull("numCat")) {
                    obj = (io.realm.CategoryRealmProxy) realm.createObjectInternal(com.geogreenapps.apps.indukaan.classes.Category.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.CategoryRealmProxy) realm.createObjectInternal(com.geogreenapps.apps.indukaan.classes.Category.class, json.getInt("numCat"), true, excludeFields);
                }
            } else {
        ...
        if (json.has("logo")) {
            if (json.isNull("logo")) {
                ...
                com.geogreenapps.apps.indukaan.classes.Images logoObj = ImagesRealmProxy.createOrUpdateUsingJsonObject(realm, json.getJSONObject("logo"), update);
    ...
    public static com.geogreenapps.apps.indukaan.classes.Category createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.geogreenapps.apps.indukaan.classes.Category obj = new com.geogreenapps.apps.indukaan.classes.Category();
        final CategoryRealmProxyInterface objProxy = (CategoryRealmProxyInterface) obj;
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (false) {
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    com.geogreenapps.apps.indukaan.classes.Images logoObj = ImagesRealmProxy.createUsingJsonStream(realm, reader);
                    objProxy.realmSet$logo(logoObj);
                }
    ...
    public static com.geogreenapps.apps.indukaan.classes.Category copyOrUpdate(Realm realm, com.geogreenapps.apps.indukaan.classes.Category object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.geogreenapps.apps.indukaan.classes.Category) cachedRealmObject;
        }

        com.geogreenapps.apps.indukaan.classes.Category realmObject = null;
    ...
    public static com.geogreenapps.apps.indukaan.classes.Category copy(Realm realm, com.geogreenapps.apps.indukaan.classes.Category newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.geogreenapps.apps.indukaan.classes.Category realmObject = realm.createObjectInternal(com.geogreenapps.apps.indukaan.classes.Category.class, ((CategoryRealmProxyInterface) newObject).realmGet$numCat(), false, Collections.<String>emptyList());
        ...
        com.geogreenapps.apps.indukaan.classes.Images logoObj = realmObjectSource.realmGet$logo();
        if (logoObj == null) {
            realmObjectCopy.realmSet$logo(null);
        } else {
            com.geogreenapps.apps.indukaan.classes.Images cachelogo = (com.geogreenapps.apps.indukaan.classes.Images) cache.get(logoObj);
            if (cachelogo != null) {
    ...
    public static long insert(Realm realm, com.geogreenapps.apps.indukaan.classes.Category object, Map<RealmModel,Long> cache) {
        ...
        com.geogreenapps.apps.indukaan.classes.Images logoObj = ((CategoryRealmProxyInterface) object).realmGet$logo();
        if (logoObj != null) {
        ...
        com.geogreenapps.apps.indukaan.classes.Images imagesObj = ((CategoryRealmProxyInterface) object).realmGet$images();
        if (imagesObj != null) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        CategoryColumnInfo columnInfo = (CategoryColumnInfo) realm.getSchema().getColumnInfo(com.geogreenapps.apps.indukaan.classes.Category.class);
        long pkColumnIndex = columnInfo.numCatIndex;
        com.geogreenapps.apps.indukaan.classes.Category object = null;
        while (objects.hasNext()) {
            object = (com.geogreenapps.apps.indukaan.classes.Category) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.geogreenapps.apps.indukaan.classes.Category object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.geogreenapps.apps.indukaan.classes.Category.class);
    ...
    public static com.geogreenapps.apps.indukaan.classes.Category createDetachedCopy(com.geogreenapps.apps.indukaan.classes.Category realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.geogreenapps.apps.indukaan.classes.Category unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.geogreenapps.apps.indukaan.classes.Category();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.geogreenapps.apps.indukaan.classes.Category) cachedObject.object;
            }
            unmanagedObject = (com.geogreenapps.apps.indukaan.classes.Category) cachedObject.object;
    ...
    static com.geogreenapps.apps.indukaan.classes.Category update(Realm realm, com.geogreenapps.apps.indukaan.classes.Category realmObject, com.geogreenapps.apps.indukaan.classes.Category newObject, Map<RealmModel, RealmObjectProxy> cache) {
