...
public class SavedStoresRealmProxy extends com.geogreenapps.apps.indukaan.classes.SavedStores
    ...
    private ProxyState<com.geogreenapps.apps.indukaan.classes.SavedStores> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.geogreenapps.apps.indukaan.classes.SavedStores>(this);
    ...
    @SuppressWarnings("cast")
    public static com.geogreenapps.apps.indukaan.classes.SavedStores createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(1);
        com.geogreenapps.apps.indukaan.classes.SavedStores obj = null;
        if (update) {
            Table table = realm.getTable(com.geogreenapps.apps.indukaan.classes.SavedStores.class);
            SavedStoresColumnInfo columnInfo = (SavedStoresColumnInfo) realm.getSchema().getColumnInfo(com.geogreenapps.apps.indukaan.classes.SavedStores.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.geogreenapps.apps.indukaan.classes.SavedStores.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            ...
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.SavedStoresRealmProxy) realm.createObjectInternal(com.geogreenapps.apps.indukaan.classes.SavedStores.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.SavedStoresRealmProxy) realm.createObjectInternal(com.geogreenapps.apps.indukaan.classes.SavedStores.class, json.getInt("id"), true, excludeFields);
                }
            } else {
    ...
    public static com.geogreenapps.apps.indukaan.classes.SavedStores createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.geogreenapps.apps.indukaan.classes.SavedStores obj = new com.geogreenapps.apps.indukaan.classes.SavedStores();
        final SavedStoresRealmProxyInterface objProxy = (SavedStoresRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.geogreenapps.apps.indukaan.classes.SavedStores copyOrUpdate(Realm realm, com.geogreenapps.apps.indukaan.classes.SavedStores object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.geogreenapps.apps.indukaan.classes.SavedStores) cachedRealmObject;
        }

        com.geogreenapps.apps.indukaan.classes.SavedStores realmObject = null;
    ...
    public static com.geogreenapps.apps.indukaan.classes.SavedStores copy(Realm realm, com.geogreenapps.apps.indukaan.classes.SavedStores newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.geogreenapps.apps.indukaan.classes.SavedStores realmObject = realm.createObjectInternal(com.geogreenapps.apps.indukaan.classes.SavedStores.class, ((SavedStoresRealmProxyInterface) newObject).realmGet$id(), false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.geogreenapps.apps.indukaan.classes.SavedStores object, Map<RealmModel,Long> cache) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        SavedStoresColumnInfo columnInfo = (SavedStoresColumnInfo) realm.getSchema().getColumnInfo(com.geogreenapps.apps.indukaan.classes.SavedStores.class);
        long pkColumnIndex = columnInfo.idIndex;
        com.geogreenapps.apps.indukaan.classes.SavedStores object = null;
        while (objects.hasNext()) {
            object = (com.geogreenapps.apps.indukaan.classes.SavedStores) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.geogreenapps.apps.indukaan.classes.SavedStores object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.geogreenapps.apps.indukaan.classes.SavedStores.class);
    ...
    public static com.geogreenapps.apps.indukaan.classes.SavedStores createDetachedCopy(com.geogreenapps.apps.indukaan.classes.SavedStores realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.geogreenapps.apps.indukaan.classes.SavedStores unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.geogreenapps.apps.indukaan.classes.SavedStores();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.geogreenapps.apps.indukaan.classes.SavedStores) cachedObject.object;
            }
            unmanagedObject = (com.geogreenapps.apps.indukaan.classes.SavedStores) cachedObject.object;
    ...
    static com.geogreenapps.apps.indukaan.classes.SavedStores update(Realm realm, com.geogreenapps.apps.indukaan.classes.SavedStores realmObject, com.geogreenapps.apps.indukaan.classes.SavedStores newObject, Map<RealmModel, RealmObjectProxy> cache) {
