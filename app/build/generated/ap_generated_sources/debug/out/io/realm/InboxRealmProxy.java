...
public class InboxRealmProxy extends com.geogreenapps.apps.indukaan.classes.Inbox
    ...
    private ProxyState<com.geogreenapps.apps.indukaan.classes.Inbox> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.geogreenapps.apps.indukaan.classes.Inbox>(this);
    ...
    @SuppressWarnings("cast")
    public static com.geogreenapps.apps.indukaan.classes.Inbox createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(2);
        com.geogreenapps.apps.indukaan.classes.Inbox obj = null;
        if (update) {
            Table table = realm.getTable(com.geogreenapps.apps.indukaan.classes.Inbox.class);
            InboxColumnInfo columnInfo = (InboxColumnInfo) realm.getSchema().getColumnInfo(com.geogreenapps.apps.indukaan.classes.Inbox.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.geogreenapps.apps.indukaan.classes.Inbox.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            ...
            if (json.has("discussionId")) {
                if (json.isNull("discussionId")) {
                    obj = (io.realm.InboxRealmProxy) realm.createObjectInternal(com.geogreenapps.apps.indukaan.classes.Inbox.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.InboxRealmProxy) realm.createObjectInternal(com.geogreenapps.apps.indukaan.classes.Inbox.class, json.getString("discussionId"), true, excludeFields);
                }
            } else {
    ...
    public static com.geogreenapps.apps.indukaan.classes.Inbox createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.geogreenapps.apps.indukaan.classes.Inbox obj = new com.geogreenapps.apps.indukaan.classes.Inbox();
        final InboxRealmProxyInterface objProxy = (InboxRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.geogreenapps.apps.indukaan.classes.Inbox copyOrUpdate(Realm realm, com.geogreenapps.apps.indukaan.classes.Inbox object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.geogreenapps.apps.indukaan.classes.Inbox) cachedRealmObject;
        }

        com.geogreenapps.apps.indukaan.classes.Inbox realmObject = null;
    ...
    public static com.geogreenapps.apps.indukaan.classes.Inbox copy(Realm realm, com.geogreenapps.apps.indukaan.classes.Inbox newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.geogreenapps.apps.indukaan.classes.Inbox realmObject = realm.createObjectInternal(com.geogreenapps.apps.indukaan.classes.Inbox.class, ((InboxRealmProxyInterface) newObject).realmGet$discussionId(), false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.geogreenapps.apps.indukaan.classes.Inbox object, Map<RealmModel,Long> cache) {
        ...
        com.geogreenapps.apps.indukaan.classes.User senderUserObj = ((InboxRealmProxyInterface) object).realmGet$senderUser();
        if (senderUserObj != null) {
        ...
        RealmList<com.geogreenapps.apps.indukaan.classes.Message> messagesList = ((InboxRealmProxyInterface) object).realmGet$messages();
        if (messagesList != null) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        InboxColumnInfo columnInfo = (InboxColumnInfo) realm.getSchema().getColumnInfo(com.geogreenapps.apps.indukaan.classes.Inbox.class);
        long pkColumnIndex = columnInfo.discussionIdIndex;
        com.geogreenapps.apps.indukaan.classes.Inbox object = null;
        while (objects.hasNext()) {
            object = (com.geogreenapps.apps.indukaan.classes.Inbox) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.geogreenapps.apps.indukaan.classes.Inbox object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.geogreenapps.apps.indukaan.classes.Inbox.class);
    ...
    public static com.geogreenapps.apps.indukaan.classes.Inbox createDetachedCopy(com.geogreenapps.apps.indukaan.classes.Inbox realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.geogreenapps.apps.indukaan.classes.Inbox unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.geogreenapps.apps.indukaan.classes.Inbox();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.geogreenapps.apps.indukaan.classes.Inbox) cachedObject.object;
            }
            unmanagedObject = (com.geogreenapps.apps.indukaan.classes.Inbox) cachedObject.object;
    ...
    static com.geogreenapps.apps.indukaan.classes.Inbox update(Realm realm, com.geogreenapps.apps.indukaan.classes.Inbox realmObject, com.geogreenapps.apps.indukaan.classes.Inbox newObject, Map<RealmModel, RealmObjectProxy> cache) {
