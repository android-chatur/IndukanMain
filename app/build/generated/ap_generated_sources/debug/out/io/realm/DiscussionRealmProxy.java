...
public class DiscussionRealmProxy extends com.geogreenapps.apps.indukaan.classes.Discussion
    ...
    private ProxyState<com.geogreenapps.apps.indukaan.classes.Discussion> proxyState;
    private RealmList<com.geogreenapps.apps.indukaan.classes.Message> messagesRealmList;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.geogreenapps.apps.indukaan.classes.Discussion>(this);
    ...
    public com.geogreenapps.apps.indukaan.classes.User realmGet$senderUser() {
        ...
        return proxyState.getRealm$realm().get(com.geogreenapps.apps.indukaan.classes.User.class, proxyState.getRow$realm().getLink(columnInfo.senderUserIndex), false, Collections.<String>emptyList());
    }
    ...
    public RealmList<com.geogreenapps.apps.indukaan.classes.Message> realmGet$messages() {
        ...
        if (messagesRealmList != null) {
            ...
            messagesRealmList = new RealmList<com.geogreenapps.apps.indukaan.classes.Message>(com.geogreenapps.apps.indukaan.classes.Message.class, osList, proxyState.getRealm$realm());
            return messagesRealmList;
        }
    }
    ...
    public void realmSet$messages(RealmList<com.geogreenapps.apps.indukaan.classes.Message> value) {
        if (proxyState.isUnderConstruction()) {
            ...
            if (value != null && !value.isManaged()) {
                ...
                final RealmList<com.geogreenapps.apps.indukaan.classes.Message> original = value;
                value = new RealmList<com.geogreenapps.apps.indukaan.classes.Message>();
                for (com.geogreenapps.apps.indukaan.classes.Message item : original) {
        ...
        if (value != null && value.size() == osList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                com.geogreenapps.apps.indukaan.classes.Message linkedObject = value.get(i);
    ...
    @SuppressWarnings("cast")
    public static com.geogreenapps.apps.indukaan.classes.Discussion createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(2);
        com.geogreenapps.apps.indukaan.classes.Discussion obj = null;
        if (update) {
            Table table = realm.getTable(com.geogreenapps.apps.indukaan.classes.Discussion.class);
            DiscussionColumnInfo columnInfo = (DiscussionColumnInfo) realm.getSchema().getColumnInfo(com.geogreenapps.apps.indukaan.classes.Discussion.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.geogreenapps.apps.indukaan.classes.Discussion.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            ...
            if (json.has("discussionId")) {
                if (json.isNull("discussionId")) {
                    obj = (io.realm.DiscussionRealmProxy) realm.createObjectInternal(com.geogreenapps.apps.indukaan.classes.Discussion.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.DiscussionRealmProxy) realm.createObjectInternal(com.geogreenapps.apps.indukaan.classes.Discussion.class, json.getInt("discussionId"), true, excludeFields);
                }
            } else {
        ...
        if (json.has("senderUser")) {
            if (json.isNull("senderUser")) {
                ...
                com.geogreenapps.apps.indukaan.classes.User senderUserObj = UserRealmProxy.createOrUpdateUsingJsonObject(realm, json.getJSONObject("senderUser"), update);
        ...
        if (json.has("messages")) {
            if (json.isNull("messages")) {
                ...
                for (int i = 0; i < array.length(); i++) {
                    com.geogreenapps.apps.indukaan.classes.Message item = MessageRealmProxy.createOrUpdateUsingJsonObject(realm, array.getJSONObject(i), update);
    ...
    public static com.geogreenapps.apps.indukaan.classes.Discussion createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.geogreenapps.apps.indukaan.classes.Discussion obj = new com.geogreenapps.apps.indukaan.classes.Discussion();
        final DiscussionRealmProxyInterface objProxy = (DiscussionRealmProxyInterface) obj;
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (false) {
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    com.geogreenapps.apps.indukaan.classes.User senderUserObj = UserRealmProxy.createUsingJsonStream(realm, reader);
                    objProxy.realmSet$senderUser(senderUserObj);
                }
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    objProxy.realmSet$messages(new RealmList<com.geogreenapps.apps.indukaan.classes.Message>());
                    reader.beginArray();
                    while (reader.hasNext()) {
                        com.geogreenapps.apps.indukaan.classes.Message item = MessageRealmProxy.createUsingJsonStream(realm, reader);
                        objProxy.realmGet$messages().add(item);
                    }
                    reader.endArray();
                }
    ...
    public static com.geogreenapps.apps.indukaan.classes.Discussion copyOrUpdate(Realm realm, com.geogreenapps.apps.indukaan.classes.Discussion object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.geogreenapps.apps.indukaan.classes.Discussion) cachedRealmObject;
        }

        com.geogreenapps.apps.indukaan.classes.Discussion realmObject = null;
    ...
    public static com.geogreenapps.apps.indukaan.classes.Discussion copy(Realm realm, com.geogreenapps.apps.indukaan.classes.Discussion newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.geogreenapps.apps.indukaan.classes.Discussion realmObject = realm.createObjectInternal(com.geogreenapps.apps.indukaan.classes.Discussion.class, ((DiscussionRealmProxyInterface) newObject).realmGet$discussionId(), false, Collections.<String>emptyList());
        ...
        com.geogreenapps.apps.indukaan.classes.User senderUserObj = realmObjectSource.realmGet$senderUser();
        if (senderUserObj == null) {
            realmObjectCopy.realmSet$senderUser(null);
        } else {
            com.geogreenapps.apps.indukaan.classes.User cachesenderUser = (com.geogreenapps.apps.indukaan.classes.User) cache.get(senderUserObj);
        ...
        RealmList<com.geogreenapps.apps.indukaan.classes.Message> messagesList = realmObjectSource.realmGet$messages();
        if (messagesList != null) {
            RealmList<com.geogreenapps.apps.indukaan.classes.Message> messagesRealmList = realmObjectCopy.realmGet$messages();
            messagesRealmList.clear();
            for (int i = 0; i < messagesList.size(); i++) {
                com.geogreenapps.apps.indukaan.classes.Message messagesItem = messagesList.get(i);
                com.geogreenapps.apps.indukaan.classes.Message cachemessages = (com.geogreenapps.apps.indukaan.classes.Message) cache.get(messagesItem);
    ...
    public static long insert(Realm realm, com.geogreenapps.apps.indukaan.classes.Discussion object, Map<RealmModel,Long> cache) {
        ...
        com.geogreenapps.apps.indukaan.classes.User senderUserObj = ((DiscussionRealmProxyInterface) object).realmGet$senderUser();
        if (senderUserObj != null) {
        ...
        RealmList<com.geogreenapps.apps.indukaan.classes.Message> messagesList = ((DiscussionRealmProxyInterface) object).realmGet$messages();
        if (messagesList != null) {
            OsList messagesOsList = new OsList(table.getUncheckedRow(rowIndex), columnInfo.messagesIndex);
            for (com.geogreenapps.apps.indukaan.classes.Message messagesItem : messagesList) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        DiscussionColumnInfo columnInfo = (DiscussionColumnInfo) realm.getSchema().getColumnInfo(com.geogreenapps.apps.indukaan.classes.Discussion.class);
        long pkColumnIndex = columnInfo.discussionIdIndex;
        com.geogreenapps.apps.indukaan.classes.Discussion object = null;
        while (objects.hasNext()) {
            object = (com.geogreenapps.apps.indukaan.classes.Discussion) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.geogreenapps.apps.indukaan.classes.Discussion object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.geogreenapps.apps.indukaan.classes.Discussion.class);
    ...
    public static com.geogreenapps.apps.indukaan.classes.Discussion createDetachedCopy(com.geogreenapps.apps.indukaan.classes.Discussion realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.geogreenapps.apps.indukaan.classes.Discussion unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.geogreenapps.apps.indukaan.classes.Discussion();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.geogreenapps.apps.indukaan.classes.Discussion) cachedObject.object;
            }
            unmanagedObject = (com.geogreenapps.apps.indukaan.classes.Discussion) cachedObject.object;
        ...
        if (currentDepth == maxDepth) {
            ...
            RealmList<com.geogreenapps.apps.indukaan.classes.Message> managedmessagesList = realmSource.realmGet$messages();
            RealmList<com.geogreenapps.apps.indukaan.classes.Message> unmanagedmessagesList = new RealmList<com.geogreenapps.apps.indukaan.classes.Message>();
            unmanagedCopy.realmSet$messages(unmanagedmessagesList);
            int nextDepth = currentDepth + 1;
            int size = managedmessagesList.size();
            for (int i = 0; i < size; i++) {
                com.geogreenapps.apps.indukaan.classes.Message item = MessageRealmProxy.createDetachedCopy(managedmessagesList.get(i), nextDepth, maxDepth, cache);
    ...
    static com.geogreenapps.apps.indukaan.classes.Discussion update(Realm realm, com.geogreenapps.apps.indukaan.classes.Discussion realmObject, com.geogreenapps.apps.indukaan.classes.Discussion newObject, Map<RealmModel, RealmObjectProxy> cache) {
        ...
        RealmList<com.geogreenapps.apps.indukaan.classes.Message> messagesList = realmObjectSource.realmGet$messages();
        RealmList<com.geogreenapps.apps.indukaan.classes.Message> messagesRealmList = realmObjectTarget.realmGet$messages();
