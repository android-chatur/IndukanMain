...
public class SessionRealmProxy extends com.geogreenapps.apps.indukaan.classes.Session
    ...
    private ProxyState<com.geogreenapps.apps.indukaan.classes.Session> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.geogreenapps.apps.indukaan.classes.Session>(this);
    ...
    @SuppressWarnings("cast")
    public static com.geogreenapps.apps.indukaan.classes.Session createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(1);
        com.geogreenapps.apps.indukaan.classes.Session obj = null;
        if (update) {
            Table table = realm.getTable(com.geogreenapps.apps.indukaan.classes.Session.class);
            SessionColumnInfo columnInfo = (SessionColumnInfo) realm.getSchema().getColumnInfo(com.geogreenapps.apps.indukaan.classes.Session.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.geogreenapps.apps.indukaan.classes.Session.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            ...
            if (json.has("sessionId")) {
                if (json.isNull("sessionId")) {
                    obj = (io.realm.SessionRealmProxy) realm.createObjectInternal(com.geogreenapps.apps.indukaan.classes.Session.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.SessionRealmProxy) realm.createObjectInternal(com.geogreenapps.apps.indukaan.classes.Session.class, json.getInt("sessionId"), true, excludeFields);
                }
            } else {
    ...
    public static com.geogreenapps.apps.indukaan.classes.Session createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.geogreenapps.apps.indukaan.classes.Session obj = new com.geogreenapps.apps.indukaan.classes.Session();
        final SessionRealmProxyInterface objProxy = (SessionRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.geogreenapps.apps.indukaan.classes.Session copyOrUpdate(Realm realm, com.geogreenapps.apps.indukaan.classes.Session object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.geogreenapps.apps.indukaan.classes.Session) cachedRealmObject;
        }

        com.geogreenapps.apps.indukaan.classes.Session realmObject = null;
    ...
    public static com.geogreenapps.apps.indukaan.classes.Session copy(Realm realm, com.geogreenapps.apps.indukaan.classes.Session newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.geogreenapps.apps.indukaan.classes.Session realmObject = realm.createObjectInternal(com.geogreenapps.apps.indukaan.classes.Session.class, ((SessionRealmProxyInterface) newObject).realmGet$sessionId(), false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.geogreenapps.apps.indukaan.classes.Session object, Map<RealmModel,Long> cache) {
        ...
        com.geogreenapps.apps.indukaan.classes.User userObj = ((SessionRealmProxyInterface) object).realmGet$user();
        if (userObj != null) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        SessionColumnInfo columnInfo = (SessionColumnInfo) realm.getSchema().getColumnInfo(com.geogreenapps.apps.indukaan.classes.Session.class);
        long pkColumnIndex = columnInfo.sessionIdIndex;
        com.geogreenapps.apps.indukaan.classes.Session object = null;
        while (objects.hasNext()) {
            object = (com.geogreenapps.apps.indukaan.classes.Session) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.geogreenapps.apps.indukaan.classes.Session object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.geogreenapps.apps.indukaan.classes.Session.class);
    ...
    public static com.geogreenapps.apps.indukaan.classes.Session createDetachedCopy(com.geogreenapps.apps.indukaan.classes.Session realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.geogreenapps.apps.indukaan.classes.Session unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.geogreenapps.apps.indukaan.classes.Session();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.geogreenapps.apps.indukaan.classes.Session) cachedObject.object;
            }
            unmanagedObject = (com.geogreenapps.apps.indukaan.classes.Session) cachedObject.object;
    ...
    static com.geogreenapps.apps.indukaan.classes.Session update(Realm realm, com.geogreenapps.apps.indukaan.classes.Session realmObject, com.geogreenapps.apps.indukaan.classes.Session newObject, Map<RealmModel, RealmObjectProxy> cache) {
