...
public class StoreRealmProxy extends com.geogreenapps.apps.indukaan.classes.Store
    ...
    static final class StoreColumnInfo extends ColumnInfo {
        ...
        long phoneIndex;
        long savedIndex;
        long nbrProductIndex;
        long nbrOffersIndex;
        long lastProductIndex;
        ...
        StoreColumnInfo(OsSchemaInfo schemaInfo) {
            ...
            this.nbrProductIndex = addColumnDetails("nbrProduct", objectSchemaInfo);
            this.nbrOffersIndex = addColumnDetails("nbrOffers", objectSchemaInfo);
            this.lastProductIndex = addColumnDetails("lastProduct", objectSchemaInfo);
        ...
        protected final void copy(ColumnInfo rawSrc, ColumnInfo rawDst) {
            ...
            dst.nbrProductIndex = src.nbrProductIndex;
            dst.nbrOffersIndex = src.nbrOffersIndex;
            dst.lastProductIndex = src.lastProductIndex;
    ...
    static {
        List<String> fieldNames = new ArrayList<String>(34);
        fieldNames.add("id");
        fieldNames.add("name");
        ...
        fieldNames.add("nbrProduct");
        fieldNames.add("nbrOffers");
        fieldNames.add("lastProduct");
    ...
    private ProxyState<com.geogreenapps.apps.indukaan.classes.Store> proxyState;
    private RealmList<com.geogreenapps.apps.indukaan.classes.Images> listImagesRealmList;
    private RealmList<com.geogreenapps.apps.indukaan.classes.OpeningTime> opening_time_table_listRealmList;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.geogreenapps.apps.indukaan.classes.Store>(this);
    ...
    @Override
    public com.geogreenapps.apps.indukaan.classes.User realmGet$user() {
        proxyState.getRealm$realm().checkIfValid();
        if (proxyState.getRow$realm().isNullLink(columnInfo.userIndex)) {
            return null;
        }
        return proxyState.getRealm$realm().get(com.geogreenapps.apps.indukaan.classes.User.class, proxyState.getRow$realm().getLink(columnInfo.userIndex), false, Collections.<String>emptyList());
    }

    @Override
    public void realmSet$user(com.geogreenapps.apps.indukaan.classes.User value) {
        if (proxyState.isUnderConstruction()) {
            if (!proxyState.getAcceptDefaultValue$realm()) {
                return;
            }
    ...
    @Override
    @SuppressWarnings("cast")
    public int realmGet$nbrProduct() {
        proxyState.getRealm$realm().checkIfValid();
        return (int) proxyState.getRow$realm().getLong(columnInfo.nbrProductIndex);
    }

    @Override
    public void realmSet$nbrProduct(int value) {
        if (proxyState.isUnderConstruction()) {
            if (!proxyState.getAcceptDefaultValue$realm()) {
                return;
            }
            final Row row = proxyState.getRow$realm();
            row.getTable().setLong(columnInfo.nbrProductIndex, row.getIndex(), value, true);
            return;
        }

        proxyState.getRealm$realm().checkIfValid();
        proxyState.getRow$realm().setLong(columnInfo.nbrProductIndex, value);
    }
    ...
    @Override
    @SuppressWarnings("cast")
    public String realmGet$lastProduct() {
        proxyState.getRealm$realm().checkIfValid();
        return (java.lang.String) proxyState.getRow$realm().getString(columnInfo.lastProductIndex);
    }

    @Override
    public void realmSet$lastProduct(String value) {
        if (proxyState.isUnderConstruction()) {
            if (!proxyState.getAcceptDefaultValue$realm()) {
                return;
            }
            final Row row = proxyState.getRow$realm();
            if (value == null) {
                row.getTable().setNull(columnInfo.lastProductIndex, row.getIndex(), true);
                return;
            }
            row.getTable().setString(columnInfo.lastProductIndex, row.getIndex(), value, true);
            return;
        }

        proxyState.getRealm$realm().checkIfValid();
        if (value == null) {
            proxyState.getRow$realm().setNull(columnInfo.lastProductIndex);
            return;
        }
        proxyState.getRow$realm().setString(columnInfo.lastProductIndex, value);
    }
    ...
    @Override
    public RealmList<com.geogreenapps.apps.indukaan.classes.OpeningTime> realmGet$opening_time_table_list() {
        proxyState.getRealm$realm().checkIfValid();
        // use the cached value if available
        if (opening_time_table_listRealmList != null) {
            ...
            opening_time_table_listRealmList = new RealmList<com.geogreenapps.apps.indukaan.classes.OpeningTime>(com.geogreenapps.apps.indukaan.classes.OpeningTime.class, osList, proxyState.getRealm$realm());
            return opening_time_table_listRealmList;
        }
    }

    @Override
    public void realmSet$opening_time_table_list(RealmList<com.geogreenapps.apps.indukaan.classes.OpeningTime> value) {
        if (proxyState.isUnderConstruction()) {
            if (!proxyState.getAcceptDefaultValue$realm()) {
                return;
            }
            ...
            if (value != null && !value.isManaged()) {
                final Realm realm = (Realm) proxyState.getRealm$realm();
                final RealmList<com.geogreenapps.apps.indukaan.classes.OpeningTime> original = value;
                value = new RealmList<com.geogreenapps.apps.indukaan.classes.OpeningTime>();
                for (com.geogreenapps.apps.indukaan.classes.OpeningTime item : original) {
                    if (item == null || RealmObject.isManaged(item)) {
                        value.add(item);
                    } else {
                        value.add(realm.copyToRealm(item));
        ...
        if (value != null && value.size() == osList.size()) {
            int objects = value.size();
            for (int i = 0; i < objects; i++) {
                com.geogreenapps.apps.indukaan.classes.OpeningTime linkedObject = value.get(i);
                proxyState.checkValidObject(linkedObject);
                osList.setRow(i, ((RealmObjectProxy) linkedObject).realmGet$proxyState().getRow$realm().getIndex());
            }
        } else {
    ...
    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        OsObjectSchemaInfo.Builder builder = new OsObjectSchemaInfo.Builder("Store", 34, 0);
        ...
        builder.addPersistedProperty("nbrProduct", RealmFieldType.INTEGER, !Property.PRIMARY_KEY, !Property.INDEXED, Property.REQUIRED);
        builder.addPersistedProperty("nbrOffers", RealmFieldType.INTEGER, !Property.PRIMARY_KEY, !Property.INDEXED, Property.REQUIRED);
        builder.addPersistedProperty("lastProduct", RealmFieldType.STRING, !Property.PRIMARY_KEY, !Property.INDEXED, !Property.REQUIRED);
    ...
    @SuppressWarnings("cast")
    public static com.geogreenapps.apps.indukaan.classes.Store createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(4);
        com.geogreenapps.apps.indukaan.classes.Store obj = null;
        if (update) {
            Table table = realm.getTable(com.geogreenapps.apps.indukaan.classes.Store.class);
            StoreColumnInfo columnInfo = (StoreColumnInfo) realm.getSchema().getColumnInfo(com.geogreenapps.apps.indukaan.classes.Store.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.geogreenapps.apps.indukaan.classes.Store.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            ...
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.StoreRealmProxy) realm.createObjectInternal(com.geogreenapps.apps.indukaan.classes.Store.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.StoreRealmProxy) realm.createObjectInternal(com.geogreenapps.apps.indukaan.classes.Store.class, json.getInt("id"), true, excludeFields);
                }
            } else {
        ...
        if (json.has("user")) {
            if (json.isNull("user")) {
                ...
                com.geogreenapps.apps.indukaan.classes.User userObj = UserRealmProxy.createOrUpdateUsingJsonObject(realm, json.getJSONObject("user"), update);
        ...
        if (json.has("nbrProduct")) {
            if (json.isNull("nbrProduct")) {
                throw new IllegalArgumentException("Trying to set non-nullable field 'nbrProduct' to null.");
            } else {
                objProxy.realmSet$nbrProduct((int) json.getInt("nbrProduct"));
            }
        }
        ...
        if (json.has("lastProduct")) {
            if (json.isNull("lastProduct")) {
                objProxy.realmSet$lastProduct(null);
            } else {
                objProxy.realmSet$lastProduct((String) json.getString("lastProduct"));
            }
        }
        ...
        if (json.has("opening_time_table_list")) {
            if (json.isNull("opening_time_table_list")) {
                ...
                for (int i = 0; i < array.length(); i++) {
                    com.geogreenapps.apps.indukaan.classes.OpeningTime item = OpeningTimeRealmProxy.createOrUpdateUsingJsonObject(realm, array.getJSONObject(i), update);
    ...
    public static com.geogreenapps.apps.indukaan.classes.Store createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.geogreenapps.apps.indukaan.classes.Store obj = new com.geogreenapps.apps.indukaan.classes.Store();
        final StoreRealmProxyInterface objProxy = (StoreRealmProxyInterface) obj;
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (false) {
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    com.geogreenapps.apps.indukaan.classes.User userObj = UserRealmProxy.createUsingJsonStream(realm, reader);
                    objProxy.realmSet$user(userObj);
                }
            ...
            } else if (name.equals("nbrProduct")) {
                if (reader.peek() != JsonToken.NULL) {
                    objProxy.realmSet$nbrProduct((int) reader.nextInt());
                } else {
                    reader.skipValue();
                    throw new IllegalArgumentException("Trying to set non-nullable field 'nbrProduct' to null.");
                }
            ...
            } else if (name.equals("lastProduct")) {
                if (reader.peek() != JsonToken.NULL) {
                    objProxy.realmSet$lastProduct((String) reader.nextString());
                } else {
                    reader.skipValue();
                    objProxy.realmSet$lastProduct(null);
                }
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    objProxy.realmSet$opening_time_table_list(new RealmList<com.geogreenapps.apps.indukaan.classes.OpeningTime>());
                    reader.beginArray();
                    while (reader.hasNext()) {
                        com.geogreenapps.apps.indukaan.classes.OpeningTime item = OpeningTimeRealmProxy.createUsingJsonStream(realm, reader);
                        objProxy.realmGet$opening_time_table_list().add(item);
                    }
                    reader.endArray();
                }
    ...
    public static com.geogreenapps.apps.indukaan.classes.Store copyOrUpdate(Realm realm, com.geogreenapps.apps.indukaan.classes.Store object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.geogreenapps.apps.indukaan.classes.Store) cachedRealmObject;
        }

        com.geogreenapps.apps.indukaan.classes.Store realmObject = null;
    ...
    public static com.geogreenapps.apps.indukaan.classes.Store copy(Realm realm, com.geogreenapps.apps.indukaan.classes.Store newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.geogreenapps.apps.indukaan.classes.Store realmObject = realm.createObjectInternal(com.geogreenapps.apps.indukaan.classes.Store.class, ((StoreRealmProxyInterface) newObject).realmGet$id(), false, Collections.<String>emptyList());
        ...
        com.geogreenapps.apps.indukaan.classes.User userObj = realmObjectSource.realmGet$user();
        if (userObj == null) {
            realmObjectCopy.realmSet$user(null);
        } else {
            com.geogreenapps.apps.indukaan.classes.User cacheuser = (com.geogreenapps.apps.indukaan.classes.User) cache.get(userObj);
            if (cacheuser != null) {
        ...
        realmObjectCopy.realmSet$nbrProduct(realmObjectSource.realmGet$nbrProduct());
        realmObjectCopy.realmSet$nbrOffers(realmObjectSource.realmGet$nbrOffers());
        realmObjectCopy.realmSet$lastProduct(realmObjectSource.realmGet$lastProduct());
        ...
        RealmList<com.geogreenapps.apps.indukaan.classes.OpeningTime> opening_time_table_listList = realmObjectSource.realmGet$opening_time_table_list();
        if (opening_time_table_listList != null) {
            RealmList<com.geogreenapps.apps.indukaan.classes.OpeningTime> opening_time_table_listRealmList = realmObjectCopy.realmGet$opening_time_table_list();
            opening_time_table_listRealmList.clear();
            for (int i = 0; i < opening_time_table_listList.size(); i++) {
                com.geogreenapps.apps.indukaan.classes.OpeningTime opening_time_table_listItem = opening_time_table_listList.get(i);
                com.geogreenapps.apps.indukaan.classes.OpeningTime cacheopening_time_table_list = (com.geogreenapps.apps.indukaan.classes.OpeningTime) cache.get(opening_time_table_listItem);
    ...
    public static long insert(Realm realm, com.geogreenapps.apps.indukaan.classes.Store object, Map<RealmModel,Long> cache) {
        ...
        com.geogreenapps.apps.indukaan.classes.Images imagesObj = ((StoreRealmProxyInterface) object).realmGet$images();
        if (imagesObj != null) {
        ...
        com.geogreenapps.apps.indukaan.classes.User userObj = ((StoreRealmProxyInterface) object).realmGet$user();
        if (userObj != null) {
        ...
        RealmList<com.geogreenapps.apps.indukaan.classes.Images> listImagesList = ((StoreRealmProxyInterface) object).realmGet$listImages();
        if (listImagesList != null) {
        ...
        Table.nativeSetLong(tableNativePtr, columnInfo.nbrProductIndex, rowIndex, ((StoreRealmProxyInterface) object).realmGet$nbrProduct(), false);
        ...
        String realmGet$lastProduct = ((StoreRealmProxyInterface) object).realmGet$lastProduct();
        if (realmGet$lastProduct != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.lastProductIndex, rowIndex, realmGet$lastProduct, false);
        }
        ...
        RealmList<com.geogreenapps.apps.indukaan.classes.OpeningTime> opening_time_table_listList = ((StoreRealmProxyInterface) object).realmGet$opening_time_table_list();
        if (opening_time_table_listList != null) {
            OsList opening_time_table_listOsList = new OsList(table.getUncheckedRow(rowIndex), columnInfo.opening_time_table_listIndex);
            for (com.geogreenapps.apps.indukaan.classes.OpeningTime opening_time_table_listItem : opening_time_table_listList) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        StoreColumnInfo columnInfo = (StoreColumnInfo) realm.getSchema().getColumnInfo(com.geogreenapps.apps.indukaan.classes.Store.class);
        long pkColumnIndex = columnInfo.idIndex;
        com.geogreenapps.apps.indukaan.classes.Store object = null;
        while (objects.hasNext()) {
            object = (com.geogreenapps.apps.indukaan.classes.Store) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.geogreenapps.apps.indukaan.classes.Store object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.geogreenapps.apps.indukaan.classes.Store.class);
        ...
        if (realmGet$lastProduct != null) {
            ...
            Table.nativeSetNull(tableNativePtr, columnInfo.lastProductIndex, rowIndex, false);
        }
        Table.nativeSetLong(tableNativePtr, columnInfo.category_idIndex, rowIndex, ((StoreRealmProxyInterface) object).realmGet$category_id(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.featuredIndex, rowIndex, ((StoreRealmProxyInterface) object).realmGet$featured(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.galleryIndex, rowIndex, ((StoreRealmProxyInterface) object).realmGet$gallery(), false);
    ...
    public static com.geogreenapps.apps.indukaan.classes.Store createDetachedCopy(com.geogreenapps.apps.indukaan.classes.Store realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.geogreenapps.apps.indukaan.classes.Store unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.geogreenapps.apps.indukaan.classes.Store();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.geogreenapps.apps.indukaan.classes.Store) cachedObject.object;
            }
            unmanagedObject = (com.geogreenapps.apps.indukaan.classes.Store) cachedObject.object;
        ...
        unmanagedCopy.realmSet$nbrProduct(realmSource.realmGet$nbrProduct());
        unmanagedCopy.realmSet$nbrOffers(realmSource.realmGet$nbrOffers());
        unmanagedCopy.realmSet$lastProduct(realmSource.realmGet$lastProduct());
        ...
        if (currentDepth == maxDepth) {
            ...
            RealmList<com.geogreenapps.apps.indukaan.classes.OpeningTime> managedopening_time_table_listList = realmSource.realmGet$opening_time_table_list();
            RealmList<com.geogreenapps.apps.indukaan.classes.OpeningTime> unmanagedopening_time_table_listList = new RealmList<com.geogreenapps.apps.indukaan.classes.OpeningTime>();
            ...
            for (int i = 0; i < size; i++) {
                com.geogreenapps.apps.indukaan.classes.OpeningTime item = OpeningTimeRealmProxy.createDetachedCopy(managedopening_time_table_listList.get(i), nextDepth, maxDepth, cache);
    ...
    static com.geogreenapps.apps.indukaan.classes.Store update(Realm realm, com.geogreenapps.apps.indukaan.classes.Store realmObject, com.geogreenapps.apps.indukaan.classes.Store newObject, Map<RealmModel, RealmObjectProxy> cache) {
        ...
        realmObjectTarget.realmSet$nbrProduct(realmObjectSource.realmGet$nbrProduct());
        realmObjectTarget.realmSet$nbrOffers(realmObjectSource.realmGet$nbrOffers());
        realmObjectTarget.realmSet$lastProduct(realmObjectSource.realmGet$lastProduct());
        ...
        RealmList<com.geogreenapps.apps.indukaan.classes.OpeningTime> opening_time_table_listList = realmObjectSource.realmGet$opening_time_table_list();
        RealmList<com.geogreenapps.apps.indukaan.classes.OpeningTime> opening_time_table_listRealmList = realmObjectTarget.realmGet$opening_time_table_list();
    ...
    public String toString() {
        ...
        stringBuilder.append("}");
        stringBuilder.append(",");
        stringBuilder.append("{nbrProduct:");
        stringBuilder.append(realmGet$nbrProduct());
        stringBuilder.append("}");
        stringBuilder.append(",");
        ...
        stringBuilder.append("}");
        stringBuilder.append(",");
        stringBuilder.append("{lastProduct:");
        stringBuilder.append(realmGet$lastProduct() != null ? realmGet$lastProduct() : "null");
        stringBuilder.append("}");
        stringBuilder.append(",");
