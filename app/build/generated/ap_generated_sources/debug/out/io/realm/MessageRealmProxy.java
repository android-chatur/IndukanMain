...
public class MessageRealmProxy extends com.geogreenapps.apps.indukaan.classes.Message
    ...
    private ProxyState<com.geogreenapps.apps.indukaan.classes.Message> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.geogreenapps.apps.indukaan.classes.Message>(this);
    ...
    @SuppressWarnings("cast")
    public static com.geogreenapps.apps.indukaan.classes.Message createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.geogreenapps.apps.indukaan.classes.Message obj = null;
        if (update) {
            Table table = realm.getTable(com.geogreenapps.apps.indukaan.classes.Message.class);
            MessageColumnInfo columnInfo = (MessageColumnInfo) realm.getSchema().getColumnInfo(com.geogreenapps.apps.indukaan.classes.Message.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.geogreenapps.apps.indukaan.classes.Message.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            if (json.has("messageid")) {
                if (json.isNull("messageid")) {
                    obj = (io.realm.MessageRealmProxy) realm.createObjectInternal(com.geogreenapps.apps.indukaan.classes.Message.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.MessageRealmProxy) realm.createObjectInternal(com.geogreenapps.apps.indukaan.classes.Message.class, json.getString("messageid"), true, excludeFields);
                }
            } else {
    ...
    public static com.geogreenapps.apps.indukaan.classes.Message createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.geogreenapps.apps.indukaan.classes.Message obj = new com.geogreenapps.apps.indukaan.classes.Message();
        final MessageRealmProxyInterface objProxy = (MessageRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.geogreenapps.apps.indukaan.classes.Message copyOrUpdate(Realm realm, com.geogreenapps.apps.indukaan.classes.Message object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.geogreenapps.apps.indukaan.classes.Message) cachedRealmObject;
        }

        com.geogreenapps.apps.indukaan.classes.Message realmObject = null;
    ...
    public static com.geogreenapps.apps.indukaan.classes.Message copy(Realm realm, com.geogreenapps.apps.indukaan.classes.Message newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.geogreenapps.apps.indukaan.classes.Message realmObject = realm.createObjectInternal(com.geogreenapps.apps.indukaan.classes.Message.class, ((MessageRealmProxyInterface) newObject).realmGet$messageid(), false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.geogreenapps.apps.indukaan.classes.Message object, Map<RealmModel,Long> cache) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        MessageColumnInfo columnInfo = (MessageColumnInfo) realm.getSchema().getColumnInfo(com.geogreenapps.apps.indukaan.classes.Message.class);
        long pkColumnIndex = columnInfo.messageidIndex;
        com.geogreenapps.apps.indukaan.classes.Message object = null;
        while (objects.hasNext()) {
            object = (com.geogreenapps.apps.indukaan.classes.Message) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.geogreenapps.apps.indukaan.classes.Message object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.geogreenapps.apps.indukaan.classes.Message.class);
    ...
    public static com.geogreenapps.apps.indukaan.classes.Message createDetachedCopy(com.geogreenapps.apps.indukaan.classes.Message realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.geogreenapps.apps.indukaan.classes.Message unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.geogreenapps.apps.indukaan.classes.Message();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.geogreenapps.apps.indukaan.classes.Message) cachedObject.object;
            }
            unmanagedObject = (com.geogreenapps.apps.indukaan.classes.Message) cachedObject.object;
    ...
    static com.geogreenapps.apps.indukaan.classes.Message update(Realm realm, com.geogreenapps.apps.indukaan.classes.Message realmObject, com.geogreenapps.apps.indukaan.classes.Message newObject, Map<RealmModel, RealmObjectProxy> cache) {
