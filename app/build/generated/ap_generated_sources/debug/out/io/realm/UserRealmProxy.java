...
public class UserRealmProxy extends com.geogreenapps.apps.indukaan.classes.User
    ...
    static final class UserColumnInfo extends ColumnInfo {
        ...
        UserColumnInfo(OsSchemaInfo schemaInfo) {
            ...
            this.phone_verifiedIndex = addColumnDetails("phone_verified", objectSchemaInfo);
        }
        ...
        protected final void copy(ColumnInfo rawSrc, ColumnInfo rawDst) {
            ...
            dst.phone_verifiedIndex = src.phone_verifiedIndex;
        }
    }
    ...
    static {
        ...
        fieldNames.add("phone_verified");
        FIELD_NAMES = Collections.unmodifiableList(fieldNames);
    }

    private UserColumnInfo columnInfo;
    private ProxyState<com.geogreenapps.apps.indukaan.classes.User> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.geogreenapps.apps.indukaan.classes.User>(this);
    ...
    public int realmGet$phone_verified() {
        proxyState.getRealm$realm().checkIfValid();
        return (int) proxyState.getRow$realm().getLong(columnInfo.phone_verifiedIndex);
    }

    @Override
    public void realmSet$phone_verified(int value) {
        if (proxyState.isUnderConstruction()) {
            if (!proxyState.getAcceptDefaultValue$realm()) {
                return;
            }
            final Row row = proxyState.getRow$realm();
            row.getTable().setLong(columnInfo.phone_verifiedIndex, row.getIndex(), value, true);
            return;
        }

        proxyState.getRealm$realm().checkIfValid();
        proxyState.getRow$realm().setLong(columnInfo.phone_verifiedIndex, value);
    }
    ...
    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        ...
        builder.addPersistedProperty("phone_verified", RealmFieldType.INTEGER, !Property.PRIMARY_KEY, !Property.INDEXED, Property.REQUIRED);
    ...
    @SuppressWarnings("cast")
    public static com.geogreenapps.apps.indukaan.classes.User createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(1);
        com.geogreenapps.apps.indukaan.classes.User obj = null;
        if (update) {
            Table table = realm.getTable(com.geogreenapps.apps.indukaan.classes.User.class);
            UserColumnInfo columnInfo = (UserColumnInfo) realm.getSchema().getColumnInfo(com.geogreenapps.apps.indukaan.classes.User.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.geogreenapps.apps.indukaan.classes.User.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            ...
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.UserRealmProxy) realm.createObjectInternal(com.geogreenapps.apps.indukaan.classes.User.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.UserRealmProxy) realm.createObjectInternal(com.geogreenapps.apps.indukaan.classes.User.class, json.getInt("id"), true, excludeFields);
                }
            } else {
        ...
        if (json.has("phone_verified")) {
            if (json.isNull("phone_verified")) {
                throw new IllegalArgumentException("Trying to set non-nullable field 'phone_verified' to null.");
            } else {
                objProxy.realmSet$phone_verified((int) json.getInt("phone_verified"));
            }
        }
        return obj;
    }
    ...
    public static com.geogreenapps.apps.indukaan.classes.User createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.geogreenapps.apps.indukaan.classes.User obj = new com.geogreenapps.apps.indukaan.classes.User();
        final UserRealmProxyInterface objProxy = (UserRealmProxyInterface) obj;
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            } else if (name.equals("phone_verified")) {
                if (reader.peek() != JsonToken.NULL) {
                    objProxy.realmSet$phone_verified((int) reader.nextInt());
                } else {
                    reader.skipValue();
                    throw new IllegalArgumentException("Trying to set non-nullable field 'phone_verified' to null.");
                }
    ...
    public static com.geogreenapps.apps.indukaan.classes.User copyOrUpdate(Realm realm, com.geogreenapps.apps.indukaan.classes.User object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.geogreenapps.apps.indukaan.classes.User) cachedRealmObject;
        }

        com.geogreenapps.apps.indukaan.classes.User realmObject = null;
    ...
    public static com.geogreenapps.apps.indukaan.classes.User copy(Realm realm, com.geogreenapps.apps.indukaan.classes.User newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.geogreenapps.apps.indukaan.classes.User realmObject = realm.createObjectInternal(com.geogreenapps.apps.indukaan.classes.User.class, ((UserRealmProxyInterface) newObject).realmGet$id(), false, Collections.<String>emptyList());
        ...
        realmObjectCopy.realmSet$phone_verified(realmObjectSource.realmGet$phone_verified());
        return realmObject;
    }

    public static long insert(Realm realm, com.geogreenapps.apps.indukaan.classes.User object, Map<RealmModel,Long> cache) {
        ...
        com.geogreenapps.apps.indukaan.classes.Images imagesObj = ((UserRealmProxyInterface) object).realmGet$images();
        if (imagesObj != null) {
        ...
        Table.nativeSetLong(tableNativePtr, columnInfo.phone_verifiedIndex, rowIndex, ((UserRealmProxyInterface) object).realmGet$phone_verified(), false);
        return rowIndex;
    }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        UserColumnInfo columnInfo = (UserColumnInfo) realm.getSchema().getColumnInfo(com.geogreenapps.apps.indukaan.classes.User.class);
        long pkColumnIndex = columnInfo.idIndex;
        com.geogreenapps.apps.indukaan.classes.User object = null;
        while (objects.hasNext()) {
            object = (com.geogreenapps.apps.indukaan.classes.User) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.geogreenapps.apps.indukaan.classes.User object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.geogreenapps.apps.indukaan.classes.User.class);
    ...
    public static com.geogreenapps.apps.indukaan.classes.User createDetachedCopy(com.geogreenapps.apps.indukaan.classes.User realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.geogreenapps.apps.indukaan.classes.User unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.geogreenapps.apps.indukaan.classes.User();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.geogreenapps.apps.indukaan.classes.User) cachedObject.object;
            }
            unmanagedObject = (com.geogreenapps.apps.indukaan.classes.User) cachedObject.object;
        ...
        unmanagedCopy.realmSet$phone_verified(realmSource.realmGet$phone_verified());

        return unmanagedObject;
    }

    static com.geogreenapps.apps.indukaan.classes.User update(Realm realm, com.geogreenapps.apps.indukaan.classes.User realmObject, com.geogreenapps.apps.indukaan.classes.User newObject, Map<RealmModel, RealmObjectProxy> cache) {
        ...
        realmObjectTarget.realmSet$phone_verified(realmObjectSource.realmGet$phone_verified());
        return realmObject;
    }
    ...
    public String toString() {
        ...
        stringBuilder.append("}");
        stringBuilder.append(",");
        stringBuilder.append("{phone_verified:");
        stringBuilder.append(realmGet$phone_verified());
        stringBuilder.append("}");
        stringBuilder.append("]");
