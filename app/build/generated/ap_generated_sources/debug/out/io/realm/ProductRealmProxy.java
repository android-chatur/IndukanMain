...
public class ProductRealmProxy extends com.geogreenapps.apps.indukaan.classes.Product
    ...
    static final class ProductColumnInfo extends ColumnInfo {
        ...
        long variantsIndex;
        long parent_idIndex;
        long store_order_enabledIndex;
        long store_order_based_on_opIndex;
        ...
        ProductColumnInfo(OsSchemaInfo schemaInfo) {
            ...
            this.original_valueIndex = addColumnDetails("original_value", objectSchemaInfo);
            ...
            this.store_order_enabledIndex = addColumnDetails("store_order_enabled", objectSchemaInfo);
            this.store_order_based_on_opIndex = addColumnDetails("store_order_based_on_op", objectSchemaInfo);
        }
        ...
        protected final void copy(ColumnInfo rawSrc, ColumnInfo rawDst) {
            ...
            dst.original_valueIndex = src.original_valueIndex;
            ...
            dst.store_order_enabledIndex = src.store_order_enabledIndex;
            dst.store_order_based_on_opIndex = src.store_order_based_on_opIndex;
        }
    }
    ...
    static {
        List<String> fieldNames = new ArrayList<String>(35);
        fieldNames.add("id");
        ...
        fieldNames.add("store_order_enabled");
        fieldNames.add("store_order_based_on_op");
        FIELD_NAMES = Collections.unmodifiableList(fieldNames);
    }

    private ProductColumnInfo columnInfo;
    private ProxyState<com.geogreenapps.apps.indukaan.classes.Product> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.geogreenapps.apps.indukaan.classes.Product>(this);
    ...
    public float realmGet$original_value() {
        proxyState.getRealm$realm().checkIfValid();
        return (float) proxyState.getRow$realm().getFloat(columnInfo.original_valueIndex);
    }
    ...
    public void realmSet$original_value(float value) {
        if (proxyState.isUnderConstruction()) {
            ...
            final Row row = proxyState.getRow$realm();
            row.getTable().setFloat(columnInfo.original_valueIndex, row.getIndex(), value, true);
            return;
        }

        proxyState.getRealm$realm().checkIfValid();
        proxyState.getRow$realm().setFloat(columnInfo.original_valueIndex, value);
    }
    ...
    public int realmGet$store_order_enabled() {
        proxyState.getRealm$realm().checkIfValid();
        return (int) proxyState.getRow$realm().getLong(columnInfo.store_order_enabledIndex);
    }
    ...
    public void realmSet$store_order_enabled(int value) {
        if (proxyState.isUnderConstruction()) {
            ...
            final Row row = proxyState.getRow$realm();
            row.getTable().setLong(columnInfo.store_order_enabledIndex, row.getIndex(), value, true);
            return;
        }

        proxyState.getRealm$realm().checkIfValid();
        proxyState.getRow$realm().setLong(columnInfo.store_order_enabledIndex, value);
    }
    ...
    public int realmGet$store_order_based_on_op() {
        proxyState.getRealm$realm().checkIfValid();
        return (int) proxyState.getRow$realm().getLong(columnInfo.store_order_based_on_opIndex);
    }
    ...
    public void realmSet$store_order_based_on_op(int value) {
        if (proxyState.isUnderConstruction()) {
            ...
            final Row row = proxyState.getRow$realm();
            row.getTable().setLong(columnInfo.store_order_based_on_opIndex, row.getIndex(), value, true);
            return;
        }

        proxyState.getRealm$realm().checkIfValid();
        proxyState.getRow$realm().setLong(columnInfo.store_order_based_on_opIndex, value);
    }

    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        OsObjectSchemaInfo.Builder builder = new OsObjectSchemaInfo.Builder("Product", 35, 0);
        ...
        builder.addPersistedProperty("original_value", RealmFieldType.FLOAT, !Property.PRIMARY_KEY, !Property.INDEXED, Property.REQUIRED);
        ...
        builder.addPersistedProperty("store_order_enabled", RealmFieldType.INTEGER, !Property.PRIMARY_KEY, !Property.INDEXED, Property.REQUIRED);
        builder.addPersistedProperty("store_order_based_on_op", RealmFieldType.INTEGER, !Property.PRIMARY_KEY, !Property.INDEXED, Property.REQUIRED);
    ...
    @SuppressWarnings("cast")
    public static com.geogreenapps.apps.indukaan.classes.Product createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(5);
        com.geogreenapps.apps.indukaan.classes.Product obj = null;
        if (update) {
            Table table = realm.getTable(com.geogreenapps.apps.indukaan.classes.Product.class);
            ProductColumnInfo columnInfo = (ProductColumnInfo) realm.getSchema().getColumnInfo(com.geogreenapps.apps.indukaan.classes.Product.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.geogreenapps.apps.indukaan.classes.Product.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            ...
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.ProductRealmProxy) realm.createObjectInternal(com.geogreenapps.apps.indukaan.classes.Product.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.ProductRealmProxy) realm.createObjectInternal(com.geogreenapps.apps.indukaan.classes.Product.class, json.getInt("id"), true, excludeFields);
                }
            } else {
        ...
        final ProductRealmProxyInterface objProxy = (ProductRealmProxyInterface) obj;
        if (json.has("currency")) {
        ...
        if (json.has("original_value")) {
            if (json.isNull("original_value")) {
                throw new IllegalArgumentException("Trying to set non-nullable field 'original_value' to null.");
            } else {
                objProxy.realmSet$original_value((float) json.getDouble("original_value"));
            }
        }
        if (json.has("tags")) {
            if (json.isNull("tags")) {
        ...
        if (json.has("store_order_enabled")) {
            if (json.isNull("store_order_enabled")) {
                throw new IllegalArgumentException("Trying to set non-nullable field 'store_order_enabled' to null.");
            } else {
                objProxy.realmSet$store_order_enabled((int) json.getInt("store_order_enabled"));
            }
        }
        if (json.has("store_order_based_on_op")) {
            if (json.isNull("store_order_based_on_op")) {
                throw new IllegalArgumentException("Trying to set non-nullable field 'store_order_based_on_op' to null.");
            } else {
                objProxy.realmSet$store_order_based_on_op((int) json.getInt("store_order_based_on_op"));
            }
        }
        return obj;
    }
    ...
    public static com.geogreenapps.apps.indukaan.classes.Product createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.geogreenapps.apps.indukaan.classes.Product obj = new com.geogreenapps.apps.indukaan.classes.Product();
        final ProductRealmProxyInterface objProxy = (ProductRealmProxyInterface) obj;
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            } else if (name.equals("original_value")) {
                if (reader.peek() != JsonToken.NULL) {
                    objProxy.realmSet$original_value((float) reader.nextDouble());
                } else {
                    reader.skipValue();
                    throw new IllegalArgumentException("Trying to set non-nullable field 'original_value' to null.");
                }
            ...
            } else if (name.equals("store_order_enabled")) {
                if (reader.peek() != JsonToken.NULL) {
                    objProxy.realmSet$store_order_enabled((int) reader.nextInt());
                } else {
                    reader.skipValue();
                    throw new IllegalArgumentException("Trying to set non-nullable field 'store_order_enabled' to null.");
                }
            } else if (name.equals("store_order_based_on_op")) {
                if (reader.peek() != JsonToken.NULL) {
                    objProxy.realmSet$store_order_based_on_op((int) reader.nextInt());
                } else {
                    reader.skipValue();
                    throw new IllegalArgumentException("Trying to set non-nullable field 'store_order_based_on_op' to null.");
                }
    ...
    public static com.geogreenapps.apps.indukaan.classes.Product copyOrUpdate(Realm realm, com.geogreenapps.apps.indukaan.classes.Product object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.geogreenapps.apps.indukaan.classes.Product) cachedRealmObject;
        }

        com.geogreenapps.apps.indukaan.classes.Product realmObject = null;
        boolean canUpdate = update;
        if (canUpdate) {
            Table table = realm.getTable(com.geogreenapps.apps.indukaan.classes.Product.class);
            ProductColumnInfo columnInfo = (ProductColumnInfo) realm.getSchema().getColumnInfo(com.geogreenapps.apps.indukaan.classes.Product.class);
            long pkColumnIndex = columnInfo.idIndex;
            long rowIndex = table.findFirstLong(pkColumnIndex, ((ProductRealmProxyInterface) object).realmGet$id());
            if (rowIndex == Table.NO_MATCH) {
                canUpdate = false;
            } else {
                try {
    ...
    public static com.geogreenapps.apps.indukaan.classes.Product copy(Realm realm, com.geogreenapps.apps.indukaan.classes.Product newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.geogreenapps.apps.indukaan.classes.Product realmObject = realm.createObjectInternal(com.geogreenapps.apps.indukaan.classes.Product.class, ((ProductRealmProxyInterface) newObject).realmGet$id(), false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        ProductRealmProxyInterface realmObjectSource = (ProductRealmProxyInterface) newObject;
        ProductRealmProxyInterface realmObjectCopy = (ProductRealmProxyInterface) realmObject;
        ...
        realmObjectCopy.realmSet$original_value(realmObjectSource.realmGet$original_value());
        ...
        realmObjectCopy.realmSet$store_order_enabled(realmObjectSource.realmGet$store_order_enabled());
        realmObjectCopy.realmSet$store_order_based_on_op(realmObjectSource.realmGet$store_order_based_on_op());
        return realmObject;
    }

    public static long insert(Realm realm, com.geogreenapps.apps.indukaan.classes.Product object, Map<RealmModel,Long> cache) {
        ...
        if (primaryKeyValue != null) {
            rowIndex = Table.nativeFindFirstInt(tableNativePtr, pkColumnIndex, ((ProductRealmProxyInterface) object).realmGet$id());
        }
        if (rowIndex == Table.NO_MATCH) {
            rowIndex = OsObject.createRowWithPrimaryKey(table, pkColumnIndex, ((ProductRealmProxyInterface) object).realmGet$id());
        } else {
            Table.throwDuplicatePrimaryKeyException(primaryKeyValue);
        }
        cache.put(object, rowIndex);

        com.geogreenapps.apps.indukaan.classes.Currency currencyObj = ((ProductRealmProxyInterface) object).realmGet$currency();
        if (currencyObj != null) {
        ...
        Table.nativeSetLong(tableNativePtr, columnInfo.store_idIndex, rowIndex, ((ProductRealmProxyInterface) object).realmGet$store_id(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.user_idIndex, rowIndex, ((ProductRealmProxyInterface) object).realmGet$user_id(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.statusIndex, rowIndex, ((ProductRealmProxyInterface) object).realmGet$status(), false);
        String realmGet$date_start = ((ProductRealmProxyInterface) object).realmGet$date_start();
        ...
        String realmGet$date_end = ((ProductRealmProxyInterface) object).realmGet$date_end();
        ...
        String realmGet$store_name = ((ProductRealmProxyInterface) object).realmGet$store_name();
        ...
        com.geogreenapps.apps.indukaan.classes.Images imagesObj = ((ProductRealmProxyInterface) object).realmGet$images();
        if (imagesObj != null) {
        ...
        RealmList<com.geogreenapps.apps.indukaan.classes.Images> listImagesList = ((ProductRealmProxyInterface) object).realmGet$listImages();
        if (listImagesList != null) {
        ...
        Double realmGet$distance = ((ProductRealmProxyInterface) object).realmGet$distance();
        if (realmGet$distance != null) {
            Table.nativeSetDouble(tableNativePtr, columnInfo.distanceIndex, rowIndex, realmGet$distance, false);
        }
        Double realmGet$lat = ((ProductRealmProxyInterface) object).realmGet$lat();
        if (realmGet$lat != null) {
            Table.nativeSetDouble(tableNativePtr, columnInfo.latIndex, rowIndex, realmGet$lat, false);
        }
        Double realmGet$lng = ((ProductRealmProxyInterface) object).realmGet$lng();
        if (realmGet$lng != null) {
            Table.nativeSetDouble(tableNativePtr, columnInfo.lngIndex, rowIndex, realmGet$lng, false);
        }
        Table.nativeSetLong(tableNativePtr, columnInfo.featuredIndex, rowIndex, ((ProductRealmProxyInterface) object).realmGet$featured(), false);
        String realmGet$link = ((ProductRealmProxyInterface) object).realmGet$link();
        if (realmGet$link != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.linkIndex, rowIndex, realmGet$link, false);
        }
        String realmGet$description = ((ProductRealmProxyInterface) object).realmGet$description();
        if (realmGet$description != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.descriptionIndex, rowIndex, realmGet$description, false);
        }
        String realmGet$short_description = ((ProductRealmProxyInterface) object).realmGet$short_description();
        ...
        String realmGet$product_type = ((ProductRealmProxyInterface) object).realmGet$product_type();
        ...
        Table.nativeSetFloat(tableNativePtr, columnInfo.product_valueIndex, rowIndex, ((ProductRealmProxyInterface) object).realmGet$product_value(), false);
        Table.nativeSetFloat(tableNativePtr, columnInfo.original_valueIndex, rowIndex, ((ProductRealmProxyInterface) object).realmGet$original_value(), false);
        String realmGet$tags = ((ProductRealmProxyInterface) object).realmGet$tags();
        if (realmGet$tags != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.tagsIndex, rowIndex, realmGet$tags, false);
        }
        Table.nativeSetLong(tableNativePtr, columnInfo.is_dealIndex, rowIndex, ((ProductRealmProxyInterface) object).realmGet$is_deal(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.order_enabledIndex, rowIndex, ((ProductRealmProxyInterface) object).realmGet$order_enabled(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.qty_enabledIndex, rowIndex, ((ProductRealmProxyInterface) object).realmGet$qty_enabled(), false);
        String realmGet$order_button = ((ProductRealmProxyInterface) object).realmGet$order_button();
        ...
        Table.nativeSetLong(tableNativePtr, columnInfo.cf_idIndex, rowIndex, ((ProductRealmProxyInterface) object).realmGet$cf_id(), false);

        RealmList<com.geogreenapps.apps.indukaan.classes.CF> cfList = ((ProductRealmProxyInterface) object).realmGet$cf();
        if (cfList != null) {
        ...
        Table.nativeSetLong(tableNativePtr, columnInfo.commissionIndex, rowIndex, ((ProductRealmProxyInterface) object).realmGet$commission(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.stockIndex, rowIndex, ((ProductRealmProxyInterface) object).realmGet$stock(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.is_offerIndex, rowIndex, ((ProductRealmProxyInterface) object).realmGet$is_offer(), false);

        RealmList<com.geogreenapps.apps.indukaan.classes.Variant> variantsList = ((ProductRealmProxyInterface) object).realmGet$variants();
        if (variantsList != null) {
        ...
        Table.nativeSetLong(tableNativePtr, columnInfo.parent_idIndex, rowIndex, ((ProductRealmProxyInterface) object).realmGet$parent_id(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.store_order_enabledIndex, rowIndex, ((ProductRealmProxyInterface) object).realmGet$store_order_enabled(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.store_order_based_on_opIndex, rowIndex, ((ProductRealmProxyInterface) object).realmGet$store_order_based_on_op(), false);
        return rowIndex;
    }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        ProductColumnInfo columnInfo = (ProductColumnInfo) realm.getSchema().getColumnInfo(com.geogreenapps.apps.indukaan.classes.Product.class);
        long pkColumnIndex = columnInfo.idIndex;
        com.geogreenapps.apps.indukaan.classes.Product object = null;
        while (objects.hasNext()) {
            object = (com.geogreenapps.apps.indukaan.classes.Product) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.geogreenapps.apps.indukaan.classes.Product object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.geogreenapps.apps.indukaan.classes.Product.class);
    ...
    public static com.geogreenapps.apps.indukaan.classes.Product createDetachedCopy(com.geogreenapps.apps.indukaan.classes.Product realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.geogreenapps.apps.indukaan.classes.Product unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.geogreenapps.apps.indukaan.classes.Product();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.geogreenapps.apps.indukaan.classes.Product) cachedObject.object;
            }
            unmanagedObject = (com.geogreenapps.apps.indukaan.classes.Product) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        ProductRealmProxyInterface unmanagedCopy = (ProductRealmProxyInterface) unmanagedObject;
        ProductRealmProxyInterface realmSource = (ProductRealmProxyInterface) realmObject;
        ...
        unmanagedCopy.realmSet$original_value(realmSource.realmGet$original_value());
        ...
        unmanagedCopy.realmSet$store_order_enabled(realmSource.realmGet$store_order_enabled());
        unmanagedCopy.realmSet$store_order_based_on_op(realmSource.realmGet$store_order_based_on_op());

        return unmanagedObject;
    }

    static com.geogreenapps.apps.indukaan.classes.Product update(Realm realm, com.geogreenapps.apps.indukaan.classes.Product realmObject, com.geogreenapps.apps.indukaan.classes.Product newObject, Map<RealmModel, RealmObjectProxy> cache) {
        ProductRealmProxyInterface realmObjectTarget = (ProductRealmProxyInterface) realmObject;
        ProductRealmProxyInterface realmObjectSource = (ProductRealmProxyInterface) newObject;
        com.geogreenapps.apps.indukaan.classes.Currency currencyObj = realmObjectSource.realmGet$currency();
        if (currencyObj == null) {
        ...
        realmObjectTarget.realmSet$original_value(realmObjectSource.realmGet$original_value());
        ...
        realmObjectTarget.realmSet$store_order_enabled(realmObjectSource.realmGet$store_order_enabled());
        realmObjectTarget.realmSet$store_order_based_on_op(realmObjectSource.realmGet$store_order_based_on_op());
        return realmObject;
    }
    ...
    public String toString() {
        ...
        stringBuilder.append("}");
        stringBuilder.append(",");
        stringBuilder.append("{original_value:");
        stringBuilder.append(realmGet$original_value());
        stringBuilder.append("}");
        stringBuilder.append(",");
        ...
        stringBuilder.append("}");
        stringBuilder.append(",");
        stringBuilder.append("{store_order_enabled:");
        stringBuilder.append(realmGet$store_order_enabled());
        stringBuilder.append("}");
        stringBuilder.append(",");
        stringBuilder.append("{store_order_based_on_op:");
        stringBuilder.append(realmGet$store_order_based_on_op());
        stringBuilder.append("}");
        stringBuilder.append("]");
